...
const relacionesAPI_auto = {
    ...
    getById: async function(id_relacion) {
        let response = await axios.get(`${BASE_URL}/relaciones/${id_relacion}`, requestOptions);
    ...
    update: async function(formData, id_relacion) {
        let response = await axios.put(`${BASE_URL}/relaciones/${id_relacion}`, formData, requestOptions);
        return response.data;
    },

    /** Deletes an existing entry in 'relaciones' by its primary key */
    delete: async function(id_relacion) {
        let response = await axios.delete(`${BASE_URL}/relaciones/${id_relacion}`, requestOptions);
        return response.data;
    },
};
